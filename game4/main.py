...
class Game:
    def __init__(self):
        ...
        self.font = pg.font.Font("D:/pyGaming/game4/assets/font.ttf",24)
    ...
    def saveScore(self):
        self.udb.save_score_to_db(self.score,self.user_id)     
        
    def start_session(self):
        self.udb.start_session(self.user_id)      
        
    def end_session(self):
        self.udb.end_game_session(self.user_id)    
        
    def leader(self):
        self.udb.leader(self.score,self.user_id)            
    ...
    def setUpBgAndGround(self):
        #loading img for ground and bg
        self.bg_img = pg.transform.scale_by(pg.image.load("D:/pyGaming/game4/assets/bg.png").convert(),self.scale_factor)
        self.ground1_img = pg.transform.scale_by(pg.image.load("D:/pyGaming/game4/assets/ground.png").convert(),self.scale_factor)
        self.ground2_img = pg.transform.scale_by(pg.image.load("D:/pyGaming/game4/assets/ground.png").convert(),self.scale_factor)
